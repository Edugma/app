package com.edugma.core.designSystem.atoms.placeholder
 ...
 * [Modifier.placeholderInternal], along with the values provided by [PlaceholderDefaults].
 *
...
fun Modifier.placeholder(
    ...
    Modifier.placeholderInternal(
        ...
        shape = shape ?: EdTheme.shapes.small,
        highlight = highlight,
...
/**
 * Contains default values used by [Modifier.placeholderInternal] and [PlaceholderHighlight].
 */
object PlaceholderDefaults {
    ...
    fun shimmerHighlightColor(
        backgroundColor: Color = EdTheme.colorScheme.inverseSurface,
        alpha: Float = 0.75f,
    ): Color {
    ...
    /**
     * Returns the value used as the the `color` parameter value on [Modifier.placeholderInternal].
     *
     * @param backgroundColor The current background color of the layout. Defaults to
